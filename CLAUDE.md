...
claudio listen --tempo 100 [--record]                   # live; writes the same trio on stop; --record also writes input.wav + recreation.wav (each session also archived under <out-dir>/<YYYYMMDD_HHMM>/)
